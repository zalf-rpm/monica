// Odin side of the phase 6 checkpoint 6 (monica_model_step/general_step/
// crop_step - the checkpoint that closes out phase 6) differential test -
// see odin/tests/cpp_ref/monica_model_step_ref_main.cpp's header comment.
...
main :: proc() {
	args := os.args
	if len(args) < 4 {
		fmt.eprintln("usage: monica_model_step_ref <pathToSimJson> <pathToClimateCsv> <numDays>")
		os.exit(2)
	}
	...
	for day in 0 ..< n {
		...
		core.monica_model_step(model, a)
