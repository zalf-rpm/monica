...
#include "Monica_AMEI_potential_Evapotranspiration/AMEIPotETComponent.h"
...
public:
  ...
  AMEIPotETComponent etComp;
  AMEIPotETState etState;
  AMEIPotETState etState1;
  AMEIPotETExogenous etExo;
  AMEIPotETRate etRate;
  AMEIPotETAuxiliary etAux;
