...
public:
  explicit RunMonica(bool startedServerInDebugMode = false,
  ...
  // mas::schema::common::Action::Client getUnregisterAction() { return
  // _unregisterAction; } void
  // setUnregisterAction(mas::schema::common::Action::Client unreg) {
