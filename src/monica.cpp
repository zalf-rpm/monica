 ...
 */
void MonicaModel::generalStep(Date date, const std::map<int, double>& climateData)
{
...
void MonicaModel::cropStep(Tools::Date date, const std::map<int, double>& climateData)
{
  ...
  // test if data for relhumid are available; if not, value is set to -1.0
  double relhumid = climateData.find(Climate::relhumid)
