...
struct FvCB_leaf_fraction {
  ...
  double kc; //�mol mol-1 mbar-1 ... Michaelis - Menten constant for CO2 reaction of rubisco per canopy layer
  double ko; //�mol mol-1 mbar-1 ... Michaelis - Menten constant for O2 reaction of rubisco per canopy layer
  ...
  double comp; //�mol mol-1 ... CCO2 compensation point at 25oC per canopy layer
  double vcMax; //�mol m-2 s-1 ... actual activity state of rubisco  (unit leaf area)
  double jMax; //�mol m-2 s-1 ... actual electron transport capacity (unit leaf area)
