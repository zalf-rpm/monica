...
monica::getHermesEnvFromConfiguration(HermesSimulationConfiguration *hermes_config)
{
  ...
  std::string outputPath = fixSystemSeparator(hermes_config->getOutputPath() + "/");
  ...
  Climate::DataAccessor climateData =
    climateDataFromHermesFiles(file,
                               hermes_config->getStartYear(),
                               hermes_config->getEndYear(),
                               cpp,
                               true);
  ...
  vector<CultivationMethod> ff = 
    cropRotationFromHermesFile(file, 
                               hermes_config->useAutomaticHarvest(), 
                               hermes_config->getAutomaticHarvestParameters());
