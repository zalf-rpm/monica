...
Errors SimulationParameters::merge(json11::Json j) {
  ...
  set_string_value(evapotranspirationModel, j, "EvapotranspirationModel");
...
json11::Json SimulationParameters::to_json() const {
  return json11::Json::object
  {
    ...
    {"SoilTempModel", soilTempModel},
    {"EvapotranspirationModel", evapotranspirationModel},
    {"customDate", customData},
...
Errors EnvironmentParameters::merge(json11::Json j) {
  ...
  auto rcpNo2rcpEnum = [&](int rcpNo) {
    ...
    case 26: return RCP::RCP26;
      break;
    case 34: res.appendWarning(kj::str("RCP", rcpNo, " currently not supported. Default RCP 8.5 is used.").cStr());
      return RCP::RCP34;
      break;
    ...
    case 60: return RCP::RCP60;
      break;
    case 70: res.appendWarning(kj::str("RCP", rcpNo, " currently not supported. Default RCP 8.5 is used.").cStr());
      return RCP::RCP70;
      break;
