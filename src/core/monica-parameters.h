...
struct DLL_API SpeciesParameters : public Tools::Json11Serializable {
  ...
  double EF_MONOS{0.5};
  //! = MTpool [ug gDW-1 h-1] Monoterpenes, which will be stored after synthesis in stores (mostly intra- oder intercellular space of leafs and then are being emitted; quasi evaporation)
  ...
  double AEKC{65800.0};
  //!< activation energy for Michaelis-Menten constant for CO2 (J mol-1) | MONICA default=65800.0 | LDNDC default=59356.0
  double AEKO{1400.0};
  //!< activation energy for Michaelis-Menten constant for O2 (J mol-1) | MONICA default=65800.0 | LDNDC default=35948.0
  double AEVC{68800.0};
  //!< activation energy for photosynthesis (J mol-1) | MONICA default=68800.0 | LDNDC default=58520.0
  double KC25{460.0};
  //!< Michaelis-Menten constant for CO2 at 25oC (umol mol-1 ubar-1) | MONICA default=460.0 | LDNDC default=260.0
  double KO25{330.0};
  //!< Michaelis-Menten constant for O2 at 25oC (mmol mol-1 mbar-1) | MONICA default=330.0 | LDNDC default=179.0
  ...
  //!< end dormancy of perennial crops at that DOY, start accumulating temperature sums (0 = unset)
};
...
struct DLL_API NMinApplicationParameters : public Tools::Json11Serializable {
  ...
  NMinApplicationParameters(mas::schema::model::monica::NMinApplicationParameters::Reader reader) {
    deserialize(reader);
  }
...
struct DLL_API IrrigationParameters : public Tools::Json11Serializable {
  ...
  IrrigationParameters(mas::schema::model::monica::Params::Irrigation::Parameters::Reader reader) {
    deserialize(reader);
  }
...
struct DLL_API AutomaticIrrigationParameters : public IrrigationParameters {
  ...
  AutomaticIrrigationParameters(mas::schema::model::monica::AutomaticIrrigationParameters::Reader reader) {
    deserialize(reader);
  }
...
public:
  ...
  AutomaticHarvestParameters(mas::schema::model::monica::AutomaticHarvestParameters::Reader reader) {
    deserialize(reader);
  }
...
struct DLL_API OrganicFertilizerParameters : public OrganicMatterParameters {
  ...
  OrganicFertilizerParameters(mas::schema::model::monica::Params::OrganicFertilization::Parameters::Reader reader) {
    deserialize(reader);
  }
...
struct DLL_API SimulationParameters : public Tools::Json11Serializable {
  ...
  std::string evapotranspirationModel{"internal"};
};
...
struct DLL_API SoilMoistureModuleParameters : public Tools::Json11Serializable {
  ...
  SoilMoistureModuleParameters(mas::schema::model::monica::SoilMoistureModuleParameters::Reader reader) {
    deserialize(reader);
  }
...
struct DLL_API SoilTemperatureModuleParameters : public Tools::Json11Serializable {
  ...
  SoilTemperatureModuleParameters(mas::schema::model::monica::SoilTemperatureModuleParameters::Reader reader) {
    deserialize(reader);
  }
...
struct DLL_API SoilTransportModuleParameters : public Tools::Json11Serializable {
  ...
  SoilTransportModuleParameters(mas::schema::model::monica::SoilTransportModuleParameters::Reader reader) {
    deserialize(reader);
  }
...
struct DLL_API SoilOrganicModuleParameters : public Tools::Json11Serializable {
  ...
  SoilOrganicModuleParameters(mas::schema::model::monica::SoilOrganicModuleParameters::Reader reader) {
    deserialize(reader);
  }
