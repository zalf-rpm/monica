...
double vnit(const monica::SticsParameters &ps, double NH4, double pH, double soilT, double wfps,
            double soilWaterContent, double fc, double sat);

// denitrification [mg-N/kg-soil/day]
double vdenit(const monica::SticsParameters &ps, double corg, double NO3, double soilT, double wfps,
...
NitDenitN2O N2O(const monica::SticsParameters &ps, double NO3, double wfps, double pH, double vnit,
                double vdenit);

// N2O emissions [mg-N2O-N/kg-soil/day]
NitDenitN2O N2O(const monica::SticsParameters &ps, double corg, double NO3, double soilT,
                double wfps, double soilWaterContent, double NH4, double pH, double fc, double sat);
} // namespace stics
