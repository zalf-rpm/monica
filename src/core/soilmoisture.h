...
struct SoilMoisture {
  ...
  std::vector<double> vm_PermanentWiltingPoint; //!< Soil water content at permanent wilting
                                                //!< point [m3 m-3]
  ...
  std::vector<double> vm_SaturatedHydraulicConductivity; //!< Saturated hydraulic conductivity
                                                         //!< [mm d-1]
  ...
  double vm_SurfaceRoughness{0.0}; //!< Average amplitude of surface micro-elevations to hold back
                                   //!< water in ponds [m]
...
void evapotranspiration(SoilMoisture *sm, double percentageSoilCoverage, double kcFactor,
                        double heightNN, double maxAirTemperature, double minAirTemperature,
                        double relativeHumidity, double meanAirTemperature, double windSpeed,
                        double windSpeedHeight, double globalRadiation, int developmentalStage,
                        int julianDay, double latitude, double referenceEvapotranspiration);
double referenceEvapotranspiration(SoilMoisture *sm, double heightNN, double maxAirTemperature,
                                   double minAirTemperature, double relativeHumidity,
                                   double meanAirTemperature, double windSpeed,
                                   double windSpeedHeight, double globalRadiation, int julianDay,
                                   double latitude);
double getEReducer1(const SoilMoisture *sm, int layer, double percentageSoilCoverage,
                    double referenceEvapotranspiration);
void step(SoilMoisture *sm, double depthGroundwaterTable, double precipitation,
          double maxAirTemperature, double minAirTemperature, double relativeHumidity,
          double meanAirTemperature, double windSpeed, double windSpeedHeight, double netRadiation,
          int julianDay, double referenceEvapotranspiration);
